const
  BACKGROUND = '2'; //Podklad: 2 - Èernobílý, 4 - Šedivý, 6 - Modrý, 8 - Zelený, 9 - Vlajka
  UTF_OUTPUT = '0'; //Kódování výstupného HTML: 0 = ANSI (Windows-1250), 1 = UTF-8
  SILENT = '1'; //Tichý režim: 1 - tichý režim bez hlášení, 0 - hlášení o úspìšném konci
  CACHE_DAYS = '3'; //Kolik dní uchovávat stažené XML soubory, 0 = vždy stáhnout nové
